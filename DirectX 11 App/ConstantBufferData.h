...
struct Lights
{
	...
	float fogStart = 0.f;
	DirectX::XMFLOAT4 fogColour = DirectX::XMFLOAT4(0.f, 0.f, 0.f, 1.f);
	float fogRange = 0.f;
	float fogEnabled = 0.f;		//Corresponds to boolean value, used as float for easy 16-bit alignment of struct (0 = false, 1 = true)
